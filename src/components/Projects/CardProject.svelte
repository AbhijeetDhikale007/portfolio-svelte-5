...
<div class="CardProject" bind:this={TiltCard[index]}>
    ...
    <div class='CP1'>
        <h2>{project.Title}</h2>
        <div class='CP1Div'>
            <a class='Tooltip' data-title='GitHub' href={project.urlGit} target='_blank'><img src="Icons/GitHub-white.svg" alt="Link"></a>
            <a class='Tooltip' data-title='Deployment' href={project.urlDeploy} target='_blank'><img src="Icons/Link.svg" alt="Link"></a>
        </div>
    </div>
    <hr>
    <div class='CP2'>
