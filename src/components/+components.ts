import Ico from './Icons/Ico.svelte'
...
export { Ico, Icons, Carousel, Heading, EducationCard, CardProject, CardDiv, Card1, Card2, Card3, Card4, Card5, Card6, Card7, Typewriter}